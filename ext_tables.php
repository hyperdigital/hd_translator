...
(function () {
    \TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule(
        ...
        'bottom',
        [
            \Hyperdigital\HdTranslator\Controller\Be\TranslatorController::class => 'index, list, detail, database, databaseTableFields, databaseExport, databaseImport, save, syncLocallangs, search, download, import, remove, exportTableRowIndex, exportTableRowExport, pageContentExport, pageContentExportProccess, databaseImportIndex'
        ],
        [
            'access' => 'group',
